...
class Companies extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['company_name', 'company_address', 'company_start_date', 'company_email', 'company_created_date', 'company_status'], 'required'],
            [['company_start_date', 'company_created_date'], 'safe'],
            [['company_status'], 'string'],
            [['file'],'file'],
            [['company_name','logo' ,'company_address', 'company_email'], 'string', 'max' => 100]
        ];
    }
