...
<body>
<center><h2>Welcome to consignment generation menu. Please select any of the following options</h2></center>
<nav id="ddmenu">
   <br><br><br><br>
            ...
            <div class="dropdown">
                <div class="dd-inner">
                    <div class="column">
                       ...
                       <?= Html::a(bootui\Html::encode("Delete"), 'index.php?r=consignment/index'); ?> 
